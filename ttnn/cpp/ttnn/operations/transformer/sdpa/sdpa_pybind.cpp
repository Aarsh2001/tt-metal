...
void py_bind_sdpa(py::module& module) {
    auto doc =
        ...
        Keyword args:
            ...
            sliding_window (int, optional): Defaults to `None`. Size of sliding window for attention. If provided, only attends to the last `sliding_window` tokens.
    ...
    ttnn::bind_registered_operation(
        ...
        ttnn::pybind_overload_t{
            ...
            py::arg("sliding_window").noconvert() = std::nullopt,
