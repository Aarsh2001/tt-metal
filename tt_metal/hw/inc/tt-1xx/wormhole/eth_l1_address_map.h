...
struct address_map {
    ...
    static constexpr std::int32_t MAX_L1_LOADING_ADDR = 0x3D000;  // TODO: verify
    ...
    static constexpr std::int32_t FABRIC_ROUTER_RESERVED_SIZE = 6352 - 160 - 32;  // TODO: fix
    ...
    //     AERISC_FABRIC_ROUTING_TABLE_BASE + MEM_ROUTING_TABLE_SIZE;
    static constexpr std::int32_t FABRIC_ROUTING_PATH_BASE =
        (FABRIC_ROUTER_CONFIG_BASE + FABRIC_ROUTER_CONFIG_SIZE + 32) & ~31;
    static constexpr std::int32_t AERISC_FABRIC_ROUTING_PATH_BASE_1D = FABRIC_ROUTING_PATH_BASE;
    static constexpr std::int32_t AERISC_FABRIC_ROUTING_PATH_BASE_2D =
        FABRIC_ROUTING_PATH_BASE + FABRIC_ROUTING_PATH_SIZE_1D;
    static constexpr std::int32_t AERISC_FABRIC_ROUTING_TABLE_BASE =
