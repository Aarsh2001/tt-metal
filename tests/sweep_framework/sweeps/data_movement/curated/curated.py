    ...
    *,
    ...
    if op_name == "slice":
        ...
        output_tensor = ttnn.slice(
            ttnn_input,
            starts=(slice_start_h, slice_start_w),
            ends=(slice_end_h, slice_end_w),
        ...
        torch_output = torch_input.permute(0, 1, 3, 2) if torch_input.ndim == 4 else torch_input.permute(0, 2, 1)
